...
class FormMenuSettings(FormMenuA):
    def __init__(self, game, name, master_surface, x, y, w, h, color_background, color_border, active):
        ...
        self.pb1 = ProgressBar(master=self, x=200, y=150, w=240, h=50, color_background=None, color_border=None, image_background="images/gui/set_gui_01/Comic_Border/Bars/Bar_Background01.png",
                               image_progress="images/gui/set_gui_01/Comic_Border/Bars/Bar_Segment05.png", value=4, value_max=8)
        self.pb2 = ProgressBar(master=self, x=200, y=250, w=240, h=50, color_background=None, color_border=None, image_background="images/gui/set_gui_01/Comic_Border/Bars/Bar_Background01.png",
                               image_progress="images/gui/set_gui_01/Comic_Border/Bars/Bar_Segment05.png", value=4, value_max=8)
        self.game= game
        self.volumen_music= self.pb1.value
        self.volumen_sounds= self.pb2.value
    ...
    def update(self, lista_eventos, keys, delta_ms, tiempo_actual, tiempo_restante):
        self.volumen_music = self.pb1.value
        self.volumen_sounds = self.pb2.value
        self.volumen_music = self.volumen_music/8
        self.volumen_sounds = self.volumen_sounds/8
        
        if self.volumen_music >=0.125:
            self.game.set_volume(self.volumen_music)
        else:
            self.game.mute()   
            
        if self.volumen_sounds >=0.125:
            self.game.set_sound_volume(self.volumen_sounds)
        else:
