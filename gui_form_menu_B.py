...
class FormMostrarDatos(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_background, color_border, active):
        ...
        self.boton = Button(master=self, x=40, y=300, w=90, h=80, color_background=None, color_border=None, image_background="images/gui/set_gui_01/Pixel_Border/Buttons/arrowLeft.png",
                             on_click=self.on_click_boton_active, on_click_param="form_menu_B", text="", font="Verdana", font_size=22, font_color=C_BLACK)
        self.label = Label(master=self, x=0, y=10, w=200, h=50, color_background=(53,57,69), color_border=None, text="Rating", font="Arial", font_size=20, font_color=C_BLACK)
        self.lista_widget.append(self.label)
    ...
    def on_show(self, datos):
        ...
        for i, linea in enumerate(lineas):
            label = Label(master=self, x=0, y=100*i, w=200, h=50, color_background=(53,57,69), color_border=C_BLACK, text=linea, font="Arial", font_size=16, font_color=C_BLACK)
...
class FormMenuB(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        super().__init__(name,master_surface,x,y,w,h,color_background,color_border,active)
        self.text_score=""
        self.boton1 = Button(master=self,x=0,y=150,w=200,h=40,color_background=C_GREEEN_2,color_border=C_YELLOW_2,on_click=self.on_click_boton1,on_click_param="form_game_L1",text="BACK",font="Verdana",font_size=30,font_color=C_BLACK)
        ...
        self.boton5 = Button(master=self,x=0,y=350,w=200,h=40,color_background=C_PINK,color_border=C_RED,on_click=self.on_click_boton5,on_click_param="",text="Borrar datos",font="Verdana",font_size=30,font_color=C_BLACK)
       
        self.txt1 = TextBox(master=self,x=160,y=50,w=240,h=40,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_XL_08.png",text="Ingrese su nombre",font="Verdana",font_size=20,font_color=C_BLACK)
    ...
    def update(self, lista_eventos,keys,delta_ms,tiempo_actual, tiempo_restante):
        ...
        label = Label(master=self, x=160, y=100, w=250, h=40, color_background=(53,57,69), color_border=C_BLACK, text="Score: {0}".format(self.text_score), font="Arial", font_size=30, font_color=C_BLACK)
        self.lista_widget.append(label)
